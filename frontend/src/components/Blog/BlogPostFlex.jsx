...
const BlogPostFlex = ({ post, sidebar }) => {
  return (
    <div className="w-full  overflow-hidden flex flex-col md:flex-row md:mb-8 mb-3">
      <div className={`w-full md:w-2/5 ${sidebar ? "h-28" : "h-60"}`}>
        <img className="object-center object-cover w-full h-full" src={post.img} alt="photo" />
      </div>
      <div className={`w-full md:w-3/5 text-left ${sidebar ? "p-1 space-y-2" : "p-6"} `}>
        ...
        {!sidebar && (
          <p className="text-sm mt-3 text-gray-500 dark:text-gray-300 font-normal leading-6 capitalize">
